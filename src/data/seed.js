...
export function seedHomeSections() {
  ...
  return [
    ...
    b('hexplore', 'exploreOurSchool', { title: 'More Than a School. A Place to Belong.', subtitle: 'At Highgate School, learning goes beyond textbooks. We create an environment where students are encouraged to discover their strengths, build meaningful relationships, develop confidence, and prepare for the future.', cards: [
      { id: 'exp1', title: 'Learning', description: 'Discover an engaging learning environment designed to help every student develop knowledge, curiosity, critical thinking, and confidence.', items: ['Academics', 'ICT & Technology', 'Science', 'Library'], to: '/academics', buttonLabel: 'Explore Learning', image: IMG.kidsClassroom },
      { id: 'exp2', title: 'Growing', description: 'We nurture more than academic achievement. Students develop character, leadership, responsibility, confidence, and essential life skills.', items: ['Character Development', 'Leadership', 'Life Skills', 'Student Support'], to: '/student-development', buttonLabel: 'Discover Growth', image: IMG.team },
      { id: 'exp3', title: 'Discovering', description: 'Students are encouraged to explore their interests, develop their talents, participate in activities, and discover new possibilities beyond the classroom.', items: ['Sports', 'Clubs', 'Arts & Creativity', 'Competitions'], to: '/clubs', buttonLabel: 'Explore Activities', image: IMG.soccer },
      { id: 'exp4', title: 'Belonging', description: 'Experience the friendships, traditions, celebrations, events, and community connections that make Highgate School feel like home.', items: ['School Community', 'Events', 'School Gallery', 'Parent Engagement'], to: '/student-life', buttonLabel: 'Experience School Life', image: IMG.studentsGroup }
    ], cta1: { label: 'Explore Our School', to: '/about' }, cta2: { label: 'Discover Student Life', to: '/student-life' } }, 3),
    b('hstats', 'stats', { items: [{ value: '1,150+', label: 'Students' }, { value: '42', label: 'Nationalities' }, { value: '96%', label: 'IB Pass Rate' }, { value: '40+', label: 'Clubs & Teams' }] }, 4),
    ...
    b('hprograms', 'programs', { title: 'One Journey, Every Stage' }, 6),
    ...
    b('hquote', 'quote', { quote: 'We measure success not only in exam results but in the kindness of our corridors, the courage of our questions, and the character of our graduates.', author: 'Dr. Helena Moreau', role: 'Head of School' }, 8),
    b('hnews', 'latestNews', { title: 'From the Newsroom' }, 9),
    b('hevents', 'upcomingEvents', { title: 'Mark Your Calendar' }, 10),
